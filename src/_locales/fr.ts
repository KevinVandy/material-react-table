...
export const MRT_Localization_FR: MRT_Localization = {
  ...
  dropToGroupBy: 'Déposer pour grouper par {colonne}',
  edit: 'Editer',
  expand: 'Développer',
  ...
  sortByColumnAsc: 'Trier par {colomn} croissant',
  sortByColumnDesc: 'Trier par {colomn} décroissant',
  sortedByColumnAsc: 'Trié par {colomn} croissant',
  sortedByColumnDesc: 'Trié par {colomn} décroissant',
  thenBy: ', puis par ',
