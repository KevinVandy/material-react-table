...
For a full list of all available translation keys, see [here](https://github.com/KevinVandy/material-react-table/blob/main/packages/material-react-tablesrc/_locales/en.ts)
