...
<Head>
  <title>Changelog and Roadmap - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="TailwindCSS React Table Changelog and Roadmap for future development"
  />
</Head>
...
- Added id translations that can be imported from `'tailwindcss-react-table/locales/id'`
- Added fi translations that can be imported from `'tailwindcss-react-table/locales/fi'`
...
- Added exports for `TRT_ExpandButton` and `TRT_GrabHandleButton` components
- Exported `TRT_Updater` type so it does not have to be imported from `@tanstack/react-table`
...
- Re-export all State types from TanStack Table so that they can be imported from `tailwindcss-react-table` instead of `@tanstack/react-table`
- Re-export all Virtualizer types from TanStack Virtual so that they can be imported from `tailwindcss-react-table` instead of `@tanstack/react-virtual`
- Export all MRT sortingFns, filterFns, and aggregationFns from 'tailwindcss-react-table' so that they can be imported from `tailwindcss-react-table` instead of `@tanstack/react-table`
...
- Added sv translations that can be imported from `'tailwindcss-react-table/locales/sv'`

#### v1.6.5 (2023-02-04)

- Added uk translations that can be imported from `'tailwindcss-react-table/locales/uk'`
...
- Added import for the `TRT_EditActionButtons` component for better custom row actions
...
- Added da translations that can be imported from `'tailwindcss-react-table/locales/da'`
...
- Added zh-Hans and zh-Hant translations that can be imported from `'tailwindcss-react-table/locales/zh-Hans'` and `'tailwindcss-react-table/locales/zh-Hant'` respectively
...
- Added imports for `TRT_ToolbarAlertBanner` and `TRT_ToolbarDropZone` components for custom toolbars
...
- Added nl translations that can be imported from `'tailwindcss-react-table/locales/nl'`
- Updated ru translations that can be imported from `'tailwindcss-react-table/locales/ru'`
...
- Added ro translations that can be imported from `'tailwindcss-react-table/locales/ro'`
...
- Added vi translations that can be imported from `'tailwindcss-react-table/locales/vi'`
- Upgraded to latest TanStack Table 8.6.0 for new `maxLeafRowFilterDepth` prop

#### v1.3.10 (2022-11-19)

- Added fr translations that can be imported from `'tailwindcss-react-table/locales/fr'`
...
- Added tr translations that can be imported from `'tailwindcss-react-table/locales/tr'`
...
- Added fa translations that can be imported from `'tailwindcss-react-table/locales/fa'`
...
- Added it translations that can be imported from `'tailwindcss-react-table/locales/it'`
...
- Added ru translations that can be imported from `'tailwindcss-react-table/locales/ru'`

#### v1.0.9 (2022-09-17)

- Added de translations that can be imported from `'tailwindcss-react-table/locales/de'`
...
- Added cs translations that can be imported from `'tailwindcss-react-table/locales/cs'`

#### v1.0.3 (2022-09-14)

- Fixed sticky header z-index issue with select checkboxes and expand buttons
- Added pl translations that can be imported from `'tailwindcss-react-table/locales/pl'`

#### v1.0.2 (2022-09-13)

- Added es translations that can be imported from `'tailwindcss-react-table/locales/es'`
...
- v0.34.0 - rolled back to react-virtual 2.0 to fix flickering issue, TRT_Internal Toolbar components are now exported from MRT instead of in params
