...
<Head>
  <title>Cell Instance APIs - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="All the cell instance methods and objects that can be accessed from a cell in TailwindCSS React Table"
  />
  <meta
    property="og:title"
    content="TailwindCSS React Table Cell Instance API Reference"
  />
  <meta
    property="og:description"
    content="A reference of all the cell instance api methods and objects that can be used in TailwindCSS React Table"
  />
</Head>
...
> NOTE: These are NOT [props](/docs/api/props) or [column options](/docs/api/column-options) for TailwindCSS React Table. These are just static methods on a cell instance that you can use.
