...
<Head>
  <title>State Options - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="All the state options that can be used in TailwindCSS React Table"
  />
  <meta
    property="og:title"
    content="TailwindCSS React Table State Options API Reference"
  />
  <meta
    property="og:description"
    content="A reference of all the state options that can be used in TailwindCSS React Table"
  />
</Head>
