...
<Head>
  <title>Column Instance APIs - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="All the column instance methods and objects that can be accessed from a column instance in TailwindCSS React Table"
  />
  <meta
    property="og:title"
    content="TailwindCSS React Table Column Instance API Reference"
  />
  <meta
    property="og:description"
    content="A reference of all the column instance api methods and objects that can be used in TailwindCSS React Table"
  />
</Head>
...
> NOTE: These are NOT [column options](/docs/api/column-options) for TailwindCSS React Table. These are just static methods on a column instance that you can use.
