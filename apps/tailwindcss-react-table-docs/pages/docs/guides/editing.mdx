...
<Head>
  <title>Editing Feature Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to enable data editing features in TailwindCSS React Table"
  />
</Head>

## Editing Feature Guide

If your tables need full CRUD functionality, you can enable editing features in TailwindCSS React Table.
...
TailwindCSS React Table has four supported editing modes: `"modal"` (default), `"row"`, `"cell"` and `"table"`. You can specify which editing mode you want to use by passing the `editingMode` prop.
