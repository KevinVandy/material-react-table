...
> If your language is not yet supported, please consider making a PR to add it to the library! See [here on GitHub](https://github.com/KevinVandy/tailwindcss-react-table/tree/main/packages/tailwindcss-react-table/src/_locales).
...
For a full list of all available translation keys, see [here](https://github.com/KevinVandy/tailwindcss-react-table/blob/main/packages/tailwindcss-react-table/src/_locales/en.ts)
