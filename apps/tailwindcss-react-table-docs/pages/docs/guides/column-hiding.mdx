...
<Head>
  <title>Column Hiding Feature Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to use, customize, or disable column hiding and visibility features of TailwindCSS React Table"
  />
</Head>
...
View Extra Storybook **[Examples](https://www.tailwindcss-react-table.dev/?path=/story/features-column-hiding-examples)**
