...
<Head>
  <title>Toolbar Customization Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to customize the Toolbars, add buttons to toolbars, or customize progress bars and alert banners in TailwindCSS React Table"
  />
</Head>

## Toolbar Customization Guide

This guide shows you how to [hide](#hide-or-disable-toolbars), [customize](#customize-toolbar-buttons), or [override](#override-with-custom-toolbar-components) the top and bottom toolbars in TailwindCSS React Table.
...
The `renderToolbarInternalActions` prop allows you to redefine the built-in buttons that usually reside in the top right of the top toolbar. You can reorder the icon buttons or even insert your own custom buttons. All of the built-in buttons are available to be imported from 'tailwindcss-react-table'.
...
```jsx
import TailwindCSSReactTable, {
  TRT_ShowHideColumnsButton, // import the built-in show/hide columns button
  TRT_FullScreenToggleButton, // import the built-in full screen toggle button
} from 'tailwindcss-react-table';
//...
return (
  <TailwindCSSReactTable
