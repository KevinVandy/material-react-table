...
<Head>
  <title>
    {'Detail Panel Expanding Feature Guide - TailwindCSS React Table Docs'}
  </title>
  <meta
    name="description"
    content="How to add expanding detail panels to each row in TailwindCSS React Table"
  />
</Head>

## Detail Panel (Expanding) Feature Guide

TailwindCSS React Table has multiple kinds of expanding features. This guide will show you how to use the detail panel feature to expand a single row to show more information for that row.
