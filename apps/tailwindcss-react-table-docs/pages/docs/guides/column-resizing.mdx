...
<Head>
  <title>Column Resizing Feature Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to use and customize the column resizing features of TailwindCSS React Table"
  />
</Head>

## Column Resizing Feature Guide

TailwindCSS React Table lets you easily change the default widths (sizes) of columns and has a built-in column resizing draggable handle feature.
