...
<Head>
  <title>
    Sticky Header/Footer Feature Guide - TailwindCSS React Table Docs
  </title>
  <meta
    name="description"
    content="How to use and customize the sticky header feature in TailwindCSS React Table"
  />
</Head>
...
```tsx
<TailwindCSSReactTable columns={columns} data={data} enableStickyFooter />
```
...
View Extra Storybook **[Examples](https://www.tailwindcss-react-table.dev/?path=/story/styling-sticky-header-examples)**
