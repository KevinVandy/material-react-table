...
<Head>
  <title>Density Toggle Feature Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to use, customize, or disable the density toggle button feature of TailwindCSS React Table"
  />
</Head>

## Density Toggle Feature Guide

TailwindCSS React Table includes a density toggle button in the top toolbar by default that lets you toggle between three different density levels. This is a great feature to include to help with accessibility for different user preferences, but it can also easily be disabled if desired.
...
By default, TailwindCSS React Table will render with a medium `comfortable` density.
