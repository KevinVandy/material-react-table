...
<Head>
  <title>Table Event Listeners Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to add event listeners such as onClicks and onChange events to components in TailwindCSS React Table"
  />
</Head>

## Table Event Listeners Guide

You can pretty much add ANY event listener to ANY component in TailwindCSS React Table.
