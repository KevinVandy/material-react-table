...
<Head>
  <title>Custom Icons Feature Guide - TailwindCSS React Table Docs</title>
  <meta
    name="description"
    content="How to use custom icons such as from Font Awesome in TailwindCSS React Table"
  />
</Head>

## Custom Icons Feature Guide

TailwindCSS React Table uses [Material Icons](https://mui.com/material-ui/material-icons) by default for all of its internal icons.
