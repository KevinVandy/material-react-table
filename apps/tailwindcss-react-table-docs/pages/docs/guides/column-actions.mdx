...
If you do not like the default column actions menu items that TailwindCSS React Table generates, you can provide your own custom menu items with the `renderColumnActionsMenuItems` prop. x of the column in the table.
