...
<Head>
  <title>Column Filtering Feature Guide - Material React Table V2 Docs</title>
  <meta
    name="description"
...
- `'select'` - shows a select dropdown with the options from faceted values or specified in `filterSelectOptions`
