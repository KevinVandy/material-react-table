...
First of all, if you want to enable or disable some feature for all display columns, you can just use the `defaultDisplayColumn` prop. This will apply to all display columns, including any custom display columns you create.
