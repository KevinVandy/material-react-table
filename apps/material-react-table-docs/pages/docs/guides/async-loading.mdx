...
<Head>
  <title>{'Async Loading Feature Guide - Material React Table V2 Docs'}</title>
  <meta
    name="description"
...
<TableOptionsTable
  onlyOptions={new Set(['muiSkeletonProps', 'muiLinearProgressProps', 'muiCircularProgressProps'])}
/>
