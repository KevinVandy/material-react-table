...
<Head>
  <title>{'Usage - Material React Table V3 Docs'}</title>
  <meta
    name="description"
...
To start using MaterialReactTable, you first need to [install](/docs/getting-started/install) `material-react-table` and the necessary Material UI dependencies.
