...
<Head>
  <title>V1 Changelog and Roadmap - Material React Table Docs</title>
  <meta
    name="description"
...
As of June 2023, most feature development is complete for MRT Version 1. MRT Version 2 is actively being developed. Some V1 bugs may still get fixed.

### Version 2 Roadmap (July 2023)

Version 2 should be released by July 2023. Some features and changes will include:

- Support for mostly keeping all of your MRT V1 code the same, but some props will be renamed for more conciseness and consistency.
- New `useMaterialReactTable` hook to replace `tableInstanceRef`. The full table instance will be available to you to build around more than just the MRT components.
- All internal MRT Components will be exported from MRT for you to optionally build up your own table UI for advanced use cases. Custom Toolbars will be much easier to build with a smaller bundle size too.
- New built-in Date Filters, and other advanced filtering and editing variants.
