...
Material React Table is a fully featured Material UI V9 implementation of TanStack React Table V8, written from the ground up in TypeScript.
...
Material React Table is licensed under the [MIT License](https://github.com/KevinVandy/material-react-table/blob/v3/LICENSE) and is free to use in both personal and commercial projects.
...
If you would like to contribute code to the project, please read the [Contributing Guide](https://github.com/kevinvandy/material-react-table/blob/v3/CONTRIBUTING.md) to learn how to get started.
