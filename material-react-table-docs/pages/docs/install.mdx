...
> No need to install `react-table` or `@tanstack/react-table`, as `@tanstack/react-table` (React Table V8) is already an internal&nbsp;dependency of `material-react-table`.
