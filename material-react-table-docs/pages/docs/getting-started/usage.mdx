...
<Head>
  ...
  <meta name="description" content="A brief overview of how to use material-react-table and create columns and data" />
</Head>
...
```tsx
//if you are using TypeScript, you should create a type based on the shape of your data that you can use in your column definitions
