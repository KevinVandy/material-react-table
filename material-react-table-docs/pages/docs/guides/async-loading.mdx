...
<Head>
  <title>Async Loading Feature Guide - Material React Table Docs</title>
  <meta
    name="description"
...
> This guide is mostly focused on the loading UI features. Also checkout the [Remote Data](/docs/examples/remote) and [React Query](/docs/examples/react-query) examples for server-side logic examples.
...
Instead of coding your own spinner or loading indicator, you can simply set the `isLoading` state to `true` and Material React Table will show progress bars and cell skeletons for you.
