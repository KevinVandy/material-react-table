...
> Many of the column options you can pass here are the same as the ones you can pass to the [useReactTable](https://tanstack.com/table/v8/docs/api/core/column-def) ColumnDefs
