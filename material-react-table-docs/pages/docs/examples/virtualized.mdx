...
Material React Table has a built-in row virtualization feature [(via `@tanstack/react-virual`)](https://tanstack.com/virtual/v3) that lets you render a large number of rows without major performance issues.
