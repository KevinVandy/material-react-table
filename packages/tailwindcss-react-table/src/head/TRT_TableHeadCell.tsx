...
import { TRT_TableHeadCellColumnActionsButton } from './TRT_TableHeadCellColumnActionsButton';
import { TRT_TableHeadCellFilterContainer } from './TRT_TableHeadCellFilterContainer';
import { TRT_TableHeadCellFilterLabel } from './TRT_TableHeadCellFilterLabel';
import { TRT_TableHeadCellGrabHandle } from './TRT_TableHeadCellGrabHandle';
import { TRT_TableHeadCellResizeHandle } from './TRT_TableHeadCellResizeHandle';
...
export const TRT_TableHeadCell = ({ header, table }: Props) => {
      ...
      {header.isPlaceholder ? null : (
        ...
        >
          ...
          >
            ...
            {column.getCanFilter() && (
              <TRT_TableHeadCellFilterLabel header={header} table={table} />
            )}
          </Box>
          {columnDefType !== 'group' && (
            <Box
            ...
            >
              ...
              {showColumnActions && (
                <TRT_TableHeadCellColumnActionsButton
                  header={header}
                  table={table}
                />
              )}
          ...
          {column.getCanResize() && (
            <TRT_TableHeadCellResizeHandle header={header} table={table} />
          )}
        </Box>
      )}
      {column.getCanFilter() && (
        <TRT_TableHeadCellFilterContainer header={header} table={table} />
      )}
    </TableCell>
  );
};
